...
const ResponsiveButton: React.FC<{ width: Breakpoint; color: PropTypes.Color, label: string, id?: string, onClick?: () => void, icon: React.ReactNode }> = ({width, icon, children, label, ...rest}) => {
